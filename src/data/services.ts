...
export const priceSections: PriceSection[] = [
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Коронка ZrO2 на имплантат (без учета Ti-base)', price: 7500 },
      { name: 'Индивидуальный ZrO2 абатмент (без учета Ti-base)', price: 5000 },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Одиночная коронка КЕРАМОКОМПОЗИТ на имплантат (без учета Ti-base)', price: 3400 },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Навигационый шаблон ( всё на 6-8 имплантах 1 челюсть ) + печать', price: 18000 },
      { name: 'Аренда втулки/гильзы ( 1шт)', price: 350 },
    ],
  },
  {
    id: 'removable',
    ...
    services: [
      ...
      { name: 'Съемный протез на локаторах ( без учета протетики)', price: 20000 },
